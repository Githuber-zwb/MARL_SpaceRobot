...
--n_rollout_threads 40  --use_wandb --share_policy --share_reward --hidden_size 512 --layer_N 2 --ppo_epoch 5 \
--save_interval 20 --log_interval 5 --entropy_coef 0.05 --lr 5e-4 --critic_lr 5e-4 --use_transformer
